...
interface AppShortcutDao {
    @Query(value = "SELECT * from app_shortcut order by COALESCE(`order`, `id`) ASC") fun getAll(): LiveData<List<AppShortcut>>
    @Insert fun insertAll(vararg appShortcuts: AppShortcut): List<Long>
